            ...
            <div class="g-6 flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
                <div class="w-full">
                    <div class="block rounded-lg bg-white shadow-lg dark:bg-neutral-800">
                        <div class="g-0 flex flex-wrap {{ $flex }}">
                            <!-- Left column container-->
                            <div class="px-4 md:px-0 lg:w-6/12">
                                <div class="md:mx-6 md:p-12">
                                    <!--Logo-->
                                    <div class="text-center">
                                        <svg class="mx-auto w-48" xmlns="http://www.w3.org/2000/svg" id="currentIllo"
                                            width="200" height="200" viewBox="0 0 751.57 539.42"
                                            ...
                                            <g>
                                                ...
                                                <path
                                                    ...
                                                    fill="#2f2e43"></path>
                                                <g>
                                                    <path id="uuid-00bc58e7-734f-4d7c-a085-03c0cd267642-252"
                                                ...
                                                <polygon
                                                    ...
                                                    fill="#ff676b"></polygon>
                                                <path id="uuid-ece83039-1aa0-468e-a846-e0cb6ecd6032-253"
