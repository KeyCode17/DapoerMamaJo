...
@section('admincontent')
    ...
    <div class="table-responsive col-lg-8 mb-5">
        <a href="/dashboard/promo/create" class="btn btn-primary mb-3">Create New Post</a>
